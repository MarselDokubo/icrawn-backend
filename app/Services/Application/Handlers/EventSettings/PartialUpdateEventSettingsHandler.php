...
readonly class PartialUpdateEventSettingsHandler
{
    ...
    {
        // event_settings.find
        $existingSettings = TxnProbe::step('event_settings.find', function () use ($eventSettingsDTO) {
        ...
        $locationDetails = AddressDTO::from(
            $eventSettingsDTO->settings['location_details'] ?? $existingSettings->getLocationDetails()
        );
        ...
        // event_settings.update (this will bubble up any SQL failure from the inner handler)
        return TxnProbe::step('event_settings.update', function () use ($eventSettingsDTO, $existingSettings, $locationDetails) {
