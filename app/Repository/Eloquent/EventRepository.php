...
class EventRepository extends BaseRepository implements EventRepositoryInterface
{
    ...
    /**
     * Fetch all public events, optionally paginated/filtered.
     */
    public function findAllPublicEvents(QueryParamsDTO $params): LengthAwarePaginator
        {
            $where = [];
            $where[] = static function (Builder $builder) {
                $builder
                    ->where(EventDomainObjectAbstract::STATUS, EventStatus::LIVE->name)
                    ->where(function ($q) {
