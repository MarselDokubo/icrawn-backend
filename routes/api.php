...
use HiEvents\Http\Actions\Payments\InitializePaystackAction;
use HiEvents\Http\Actions\Payments\VerifyPaystackAction;
use HiEvents\Http\Actions\Payments\PaystackCallbackAction;
...
$router->prefix('/public')->group(
    ...
    // Events
        ...
        $router->post('/events/{event_id}/order/{order_short_id}/paystack/initialize', InitializePaystackAction::class);
        $router->get('/events/{event_id}/order/{order_short_id}/paystack/verify', VerifyPaystackAction::class);
